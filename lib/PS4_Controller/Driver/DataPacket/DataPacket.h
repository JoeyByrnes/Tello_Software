...
struct DataPacket {
    ...
    unsigned int  reportID               : PS4_BYTE;                                                                                   // 3
    unsigned int  leftStick_X            : PS4_BYTE;   // (0 = left)                                                                   // 4
    unsigned int  leftStick_Y            : PS4_BYTE;   // (0 = up)                                                                     // 5
    unsigned int  rightStick_X           : PS4_BYTE;   // (0 = left)                                                                   // 6
    unsigned int  rightStick_Y           : PS4_BYTE;   // (0 = up)                                                                     // 7
    ...
    unsigned int  leftTrigger            : PS4_BYTE;   // (0 = released, 0xFF = fully pressed)                                         // 11
    unsigned int  rightTrigger           : PS4_BYTE;   // (0 = released, 0xFF = fully pressed)                                         // 12
    unsigned int  timestamp              : PS4_BYTE*2;                                                                                 // 13 ~ 14
    unsigned int  battery                : PS4_BYTE;   // 0x00 - 0xFF                                                                  // 15
    signed int    acceleration_X         : PS4_BYTE*2;                                                                                 // 16 ~ 17
    signed int    acceleration_Y         : PS4_BYTE*2;                                                                                 // 18 ~ 19
    signed int    acceleration_Z         : PS4_BYTE*2;                                                                                 // 20 ~ 21
    signed int    gyroscopeRoll          : PS4_BYTE*2;                                                                                 // 22 ~ 23
    signed int    gyroscopeYaw           : PS4_BYTE*2;                                                                                 // 24 ~ 25
    signed int    gyroscopePitch         : PS4_BYTE*2; // Not sure                                                                     // 26 ~ 27
    ...
    unsigned int  trackpadPackets        : PS4_BYTE;   // number of trackpad packets (0x00 to 0x04)                                    // 36
    ...
    uint32_t      CRC                    : PS4_BYTE*4; // TODO: CRC-32 of the first 75 bytes                                           // 75 ~ 78
