...
void dash_kin::SRB_FK(MatrixXd& torso_vertices, MatrixXd& right_leg, MatrixXd& left_leg, MatrixXd& lfv, SRB_Params srb_params, VectorXd x, MatrixXd q)
{
    ...
    HTMcom2hr.block(0,3,3,1) = Eigen::Vector3d(CoM_X_Offset, -W/2.0+COM_Y_Offset, -CoM2H_z_dist);
    ...
    HTMcom2hl.block(0,3,3,1) = Eigen::Vector3d(CoM_X_Offset, W/2.0+COM_Y_Offset, -CoM2H_z_dist);
