...
namespace  dash_planner
{
    ...
    void SRB_Traj_Planner(SRB_Params srb_params, Human_dyn_data &human_dyn_data, HMI_extended_data hmi_extended_data, Traj_planner_dyn_data &traj_planner_dyn_data, Human_params human_params,
