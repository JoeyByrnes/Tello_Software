...
#define RIGHT_EE_IDX 1 // idx of front right line foot pt
#define LEFT_EE_IDX 3 // idx of front left line foot pt
...
namespace  dash_kin
{
    ...
    void SRB_FK(MatrixXd& torso_vertices, MatrixXd& right_leg, MatrixXd& left_leg, MatrixXd& lfv, SRB_Params srb_params, VectorXd x, VectorXd q);
    MatrixXd SRB_IK(SRB_Params srb_params, VectorXd CoM, MatrixXd R, MatrixXd lfv);
    void SRB_Kin(VectorXd& q, VectorXd& qd, MatrixXd* Jv_mat, SRB_Params srb_params, VectorXd x, MatrixXd lfv, MatrixXd lfdv);
