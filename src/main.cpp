...
int main(int argc, char *argv[]) {
	...
	if(simulation_mode == 1)
	{
		...
		// tello->addPeriodicTask(&tello_controller, SCHED_FIFO, 98, 12, (void*)(NULL),"tello_ctrl",TASK_CONSTANT_PERIOD, 1000);
		tello->addPeriodicTask(&PS4_Controller, SCHED_FIFO, 90, 13, (void*)(NULL),"ps4_controller_task",TASK_CONSTANT_PERIOD, 2000);
		// tello->addPeriodicTask(&rx_UDP, SCHED_FIFO, 99, ISOLATED_CORE_2_THREAD_1, NULL,"rx_UDP",TASK_CONSTANT_DELAY, 100);
		tello->addPeriodicTask(&Human_Playback, SCHED_FIFO, 90, 12, (void*)(NULL),"human_playback_task",TASK_CONSTANT_PERIOD, 2000);
		tello->addPeriodicTask(&logging, SCHED_FIFO, 90, 13, (void*)(NULL),"logging_task",TASK_CONSTANT_PERIOD, 1000);
